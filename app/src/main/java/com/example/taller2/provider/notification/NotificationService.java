...
public class NotificationService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        String message = NotificationProvider.notificationUser.message;
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            builder.setContentTitle(getString(R.string.app_name)).setCategory(Notification.CATEGORY_SERVICE)
                    .setSmallIcon(R.drawable.ic_menu_available)   // required
                    .setContentText(message)
                    .setLargeIcon(BitmapFactory.decodeResource(res, R.drawable.ic_menu_available))
            ...
            notification = new NotificationCompat.Builder(this)
                    .setContentIntent(pendingIntent)
                    .setSmallIcon(R.drawable.ic_menu_available)
                    .setLargeIcon(BitmapFactory.decodeResource(res, R.drawable.ic_menu_available))
                    .setSound(soundUri)
                    .setAutoCancel(true)
